            ...
            <div className="mx-auto flex flex-wrap mb-[8rem] mt-[5rem] ">
                <div className='md:w-[45%] w-full mb-5 h-[397px] md:h-[810px] lg:h-[530px]' >
                    <div className="relative">
                        ...
                        <img alt="about" className="sm:w-[380px] h-[270px] w-[260px] md:ml-3 md:w-[740px] md:h-[710px] lg:h-[530px] lg:w-[490px] object-fill z-10 absolute top-10 left-7" src={jsonData?.plan_design?.plan_design_image[0]} />
                    </div>
                </div>
