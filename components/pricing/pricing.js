            ...
            <div className={`container  ${path === '/agent-profile' ? 'lg:w-[600px]' : ' w-full'}`}>
                ...
                >
                    {data?.docs?.map((item, i) => (
                        <SwiperSlide
                            className='relative rounded-lg bg-white p-5 transition-all ease-in-out hover:shadow-xl shadow-[0px_0px_10px_rgba(0,0,0,0.2)] mb-12'
                            key={item._id}
                        >
                                ...
                                <div className='relative'>
                                    ...
                                    <div className='absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transform '>
                                        <p className='header_5 ml-5 text-center text-white'>
                                           ${item?.price} <span className='small'>/{i18n?.t('month')}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className=' mx-auto w-full'>
                                <Link href={`/pricing-plan/${item?._id}`}>
                                    ...
                                    }} className='header_5 mt-10 w-full rounded-lg border border-secondary_text bg-white py-3 text-secondary_text transition-all ease-in-out hover:bg-primary hover:text-white '>
                                        {i18n?.t('Choose Plan')}
                                    </button>
                                </Link>
                            </div>
