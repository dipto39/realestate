...
const SingleTestimonial = ({ testimonial }) => {
    return (
        <div className='lg:!h-[280px] !h-[340px] md:!h-[310px] relative top-0 bottom-0 z-10 xl:!max-w-[486px] rounded-b-lg rounded-tr-lg bg-white p-5 md:p-8 lg:pl-16 mx-auto ml-10 md:ml-12 mb-8 md:mb-12'>
            <div className='absolute left-0 -top-6 md:-top-2 lg:top-0 h-5/6 w-2 bg-orange-500'>
            ...
            <div className='pl-6 md:pl-8 lg:pl-0'>
