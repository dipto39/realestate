...
const UserProfile = () => {
    ...
    return (
        <>
            ...
            <div className='container'>
                {/* <h1 className='header_2 md:mt-16 py-10 text-center'>{items.find(item => item.key === active)?.label}</h1> */}
                <div className='md:flex items-start gap-10 mb-20'>
                    <div className='md:w-4/12 border shadow-lg shadow-gray-400 rounded-md p-10 mb-16 md:mb-0'>
